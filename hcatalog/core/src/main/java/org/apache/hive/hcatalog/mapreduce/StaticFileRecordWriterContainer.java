 ...
 */
class StaticFileRecordWriterContainer extends FileRecordWriterContainer {
  /**
   ...
   */
  public StaticFileRecordWriterContainer(
      RecordWriter<
  ...
  protected LocalFileWriter getLocalFileWriter(HCatRecord value)
    ...
    return new LocalFileWriter(
        getBaseRecordWriter(), objectInspector, serDe, jobInfo);
  }
}
